...
class EnglishGame:
    ...
    def run(self):
        ...
        while running:
            ...
            self.screen.blit(k_space, (200, second_row_button_height - 5))
            # Up arrow near Rehear
            self.screen.blit(k_arrow_up, (470, second_row_button_height - 5))
            # Esc near Exit
            self.screen.blit(k_esc, (740, second_row_button_height - 5))
